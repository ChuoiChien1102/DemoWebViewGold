...
//to add another domain to either the blacklist or whitelist, insert another host like so: ["alwaysopeninsafari.com", "google.com", "m.facebook.com"] please enter the host exactly how you link to it (with or without www, but always without HTTP/HTTPS)

var safariwhitelist = ["alwaysopeninsafari.com",] //Add domains here that should ALWAYS be opened in Safari, regardless of what the openallexternalurlsinsafaribydefault option is set to

var safariblacklist = [host, "neversopeninsafari.com",] //Add domains here that should NEVER be opened in Safari, regardless of what the openallexternalurlsinsafaribydefault option is set to
...
static let oneSignalID = "74b245bd-6f49-4865-9235-example"; //Enter your OneSignal App ID here
